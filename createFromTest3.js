...
class Commit {
      ...
      async add() {
                await this.driver.findElement(By.xpath(newFileNameXpath)).sendKeys(process.env.NEW_FILE_NAME);
                await this.driver.sleep(3000)
                await this.driver.findElement(By.xpath(fileContentXpath)).click();
                await this.driver.sleep(1000)
        
                await this.driver.findElement(By.xpath(fileContentXpath)).sendKeys(fromFile);
                await this.driver.sleep(5000)
        
        
                await this.driver.findElement(By.xpath(commitNameXpath)).sendKeys(commitAdd);
                await this.driver.findElement(By.xpath(commit_M)).sendKeys(commitAdd_M);
                await this.driver.sleep(5000)
        
                await this.driver.findElement(By.xpath(commitNewFileXpath)).click();
      }
}
class Login {
      constructor(driver) {
